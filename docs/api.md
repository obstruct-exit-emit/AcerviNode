...
| `GET` | `/api/v1/downloads/torrent/info` | Metadata preview for a magnet or hash without adding it — name, size, file list. See [Cached & metadata previews](#cached--metadata-previews) |
